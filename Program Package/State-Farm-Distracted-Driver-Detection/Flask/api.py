...
json_file.close()
model = tf.keras.models.load_model("/Users/varunreddyseelam/Documents/GitHub/State-Farm-Distracted-Driver-Detection/Flask/model2")
...
#   img_array = cv2.imread(os.path.join(path, img), cv2.IMREAD_GRAYSCALE)
    ...
    new_img = cv2.resize(img_array, (150, 150))
    x = np.array(new_img).reshape(-1, 150, 150, 3)
